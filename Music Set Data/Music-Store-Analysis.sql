	...
	-- The city with the highest total invoice is Prague, with a invoice total of $273.24. This would be the best location to host the promotional Music Festival! 🎶🏆 ​
	...
	SELECT track.name, track.milliseconds, 
		   (SELECT AVG(milliseconds) FROM track) AS avg_duration
	FROM track;
